...
// Future<String?> receiveData3(BTDeviceStruct deviceInfo) async {
//   final device = BluetoothDevice.fromId(deviceInfo.id, name: deviceInfo.name);
//   final services = await device.discoverServices();
//   for (BluetoothService service in services) {
//     if (service.uuid.toString() == "2e400001-b5a3-f393-e0a9-e50e24dcca9e") {
//       for (BluetoothCharacteristic characteristic in service.characteristics) {
//         if (characteristic.uuid.toString() ==
//             "2e400002-b5a3-f393-e0a9-e50e24dcca9e") {
