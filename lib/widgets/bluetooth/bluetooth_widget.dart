...
import '../bluetooth_widgets/empty_devices/empty_devices_widget.dart';
...
import '../bluetooth_backend/bluetooth_backend_widget.dart';
                                                ...
                                                return Padding(
                                                  ...
                                                  child: InkWell(
                                                    ...
                                                    onTap: () async {
                                                      ...
                                                      //   }.withoutNulls,
                                                      // );
                                                      Navigator.of(context).push(MaterialPageRoute(builder: (context) => BluetoothBackendWidget(
                                                      deviceName: displayConnectedDevciesItem.name,
                                                      deviceId: displayConnectedDevciesItem.id,
                                                      deviceRssi: displayConnectedDevciesItem.rssi,
                                                    ...
                                                    child: Container(
                                                      ...
                                                      color:Color(0xFA4BB168).withOpacity(0.5),
                                                        borderRadius:
                                                            BorderRadius
                                                                .circular(16.0),
                                                        border: Border.all(
                                                                ...
                                                                Row(
                                                                  ...
                                                                  children: [
                                                                    Padding(
                                                                     ...
                                                                     //   displayConnectedDevciesItem
                                                                      //      .name,
                                                                        displayConnectedDevciesItem.name.length > 18
                                                                        ? displayConnectedDevciesItem.name.substring(0, 18) // Limit to 10 characters
                                                                        : displayConnectedDevciesItem.name,
                                                ...
                                                itemBuilder: (context,
                                                  ...
                                                  return Padding(
                                                    ...
                                                    child: InkWell(
                                                      ...
                                                      onTap: () async {
                                                        _model.hasWrite =
                                                            await actions.connectDevice(displayDevicesItem).then((result) {
                                                            bool hasWriteCharacteristic = result['hasWriteCharacteristic'] ?? false;
                                                            bool hasReadCharacteristic = result['hasReadCharacteristic'] ?? false;
                                                            });
                                                        setState(() {
                                                      ...
                                                      deviceName: displayDevicesItem.name,
                                                      deviceId: displayDevicesItem.id,
                                                      deviceRssi: displayDevicesItem.rssi,
                                                      hasWriteCharacteristic: true,
                                                      )));
                                                        setState(() {});
                                                      },
                                                                    ...
                                                                    children: [
                                                                      Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          // displayDevicesItem
                                                                          //     .name,
                                                                        displayDevicesItem.name.length > 18
                                                                        ? displayDevicesItem.name.substring(0, 18) // Limit to 10 characters
