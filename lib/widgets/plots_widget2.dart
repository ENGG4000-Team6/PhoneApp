...
// class PlotWidget2 extends StatefulWidget {
//   const PlotWidget2({Key? key}) : super(key: key);

//   @override
//   _PlotWidget2State createState() => _PlotWidget2State();
// }

// class _PlotWidget2State extends State<PlotWidget2> {
...
//                   stream: isPaused
//                       ? null
//                       : dataStream2, // Pause stream when isPaused is true
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: StreamBuilder<List<int>>(
                stream: isPaused ? null : dataStream2,
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    List<int> dataList2 = snapshot.data!;
                    updateDataPoints(dataList2);
                    return LineChart(
                      LineChartData(
                        lineBarsData: [
                          LineChartBarData(
