...
// class PlotWidget3 extends StatefulWidget {
//   const PlotWidget3({Key? key}) : super(key: key);

//   @override
//   _PlotWidget3State createState() => _PlotWidget3State();
// }

// class _PlotWidget3State extends State<PlotWidget3> {
...
//                   stream: isPaused
//                       ? null
//                       : dataStream3, // Pause stream when isPaused is true
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Expanded(
              child: StreamBuilder<List<int>>(
                stream: isPaused ? null : dataStream3,
                builder: (context, snapshot) {
                  if (snapshot.hasData) {
                    List<int> dataList3 = snapshot.data!;
                    updateDataPoints(dataList3);
                    return LineChart(
                      LineChartData(
                        lineBarsData: [
                          LineChartBarData(
